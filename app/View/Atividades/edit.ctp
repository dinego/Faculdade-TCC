						...
						<script type="text/javascript">
							...
							$(document).ready(function(){
								if (tipoAtivi == 1) {
									...
									<?php 
									$alterText = "";
									//var_dump($this->request->data['Alternativa']);
									//die();
									$cont = 1;
									foreach ($this->request->data['Alternativa'] as $key => $value) {
										$alterText .= "<div class=\"form-group\"><label class=\"control-label col-md-3 col-sm-3 col-xs-12\" for=\"descricao\">".$cont."</label><div class=\"col-md-6 col-sm-6 col-xs-12\"><div class=\"input text\"><input name=\"data[Alternativa][".$key."][alternativa]\" value=\"".$value['Alternativa']['alternativa']."\" class=\"col-md-12 col-xs-12 form-control\" maxlength=\"255\" type=\"text\" id=\"Alternativa1Alternativa\"></div></div><div class=\"col-md-1 col-sm-12 col-xs-12\"><input name=\"data[RespostaAtividade][alternativa_id]\" class=\"col-md-12 col-xs-12 form-control\" maxlength=\"1\" type=\"radio\" value=\"".$cont."\"></div></div>";
										$cont++;
									}
									?>

									$("#alternativas").html("<div class=\"ln_solid\"></div><div class=\"form-group\"><label class=\"control-label col-md-3 col-sm-3 col-xs-12\"></label><div class=\"col-md-6 col-sm-6 col-xs-12\">Alternativas</div><div class=\"col-md-2 col-sm-12 col-xs-12\">Resposta Certa</div></div><?php echo $alterText; ?></div>");
								}
							});
						</script>
						<div id="alternativas">
